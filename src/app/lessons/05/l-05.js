...
// 4. d = function(){};
// Answer:
// 1 and 4 є невірним зразком створення та ініціалізації змінної;
// 
// 05.02.2 Створи змінні наступних типів. Для тих типів, де це неможливо, напиши коментар "Типу не існує"
// 
// 1. string
// let str = 'Simple string'
// 2. char - в js такого типу даних не існує
// 3. int - в js такого типу даних не існує
// 4. float - в js такого типу даних не існує
// 5. boolean
// let isTrue = true;
// 6. interface - в js такого типу даних не існує
// 7. undefined
// let x;
// 
...
// 2. var y = x : z ? m;
// 3. var y = x ? z : m;
// Answer: 1, 2 невірне використанням оператора умовного присвоєння.
// 
// 
...
// 4. var y = function(){}
// Answer: 1, 3, 4 правильні функціональні вирази
// 
// 
...
// Answer: №2 неправильний приклад конкатенації 
...
function Tree(name) {
	this.name = name;
	console.log('Tree has been created with name ' + this.name);
	}
var tree1() = new Tree('tololya');
